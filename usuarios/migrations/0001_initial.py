    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cargo', models.CharField(max_length=b'50', verbose_name=b'Cargo Ocupado')),
            ],
            options={
                'ordering': ['nro_item'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre', models.CharField(max_length=b'20', verbose_name=b'Nombres')),
                ('paterno', models.CharField(max_length=b'20', verbose_name=b'Apellido Paterno')),
                ('materno', models.CharField(max_length=b'20', verbose_name=b'Apellido Materno')),
                ('fecha_nac', models.DateField(verbose_name=b'Fecha de Nacimiento')),
                ('direccion', models.CharField(max_length=b'100', verbose_name=b'Direcci\xc3\xb3n')),
                ('telefono', models.CharField(max_length=b'10', verbose_name=b'Telefono/Celular')),
                ('avatar', models.ImageField(upload_to=b'avatar', verbose_name=b'Seleccione Una Imagen')),
                ('activo', models.BooleanField(default=True)),
                ('tipo', models.CharField(default=b'Estudiante', max_length=b'20')),
